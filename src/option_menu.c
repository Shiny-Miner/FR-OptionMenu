...
const u8 localText_Option[] = _("{COLOR 2}{HIGHLIGHT TRANSPARENT}OPCIONES");
const u8 localText_Instructions[] = _("{COLOR 2}{HIGHLIGHT TRANSPARENT}{SIZE 0}GUARDAR    CANCELAR");
const u8 localText_TextSpeed[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}VELOC. TEXTO");
const u8 localText_BattleScene[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}ANIM. BATALLA");
const u8 localText_BattleStyle[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}TIPO COMBATE");
const u8 localText_Sound[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}SONIDO");
const u8 localText_Frame[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}IMAGEN");
const u8 localText_ButtonMode[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}CONTROLES");
const u8 localText_TextSpeedSlow[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}LENTA");
const u8 localText_TextSpeedMid[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}MEDIA");
const u8 localText_TextSpeedFast[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}RÁPIDA");
const u8 localText_BattleSceneOn[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}VER");
const u8 localText_BattleSceneOff[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}NO VER");
const u8 localText_BattleStyleShift[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}CAMBIAR");
const u8 localText_BattleStyleSet[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}FIJO");
const u8 localText_SoundMono[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}MONO");
const u8 localText_SoundStereo[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}ESTÉREO");
const u8 localText_FrameType[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}TIPO");
...
const u8 localText_TextSpeedDescription[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}Elige entre los tres niveles de\nvelocidad del texto.");
const u8 localText_BattleSceneDescription[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}Muestra o desactiva las animaciones\ndurante los combates.");
const u8 localText_BattleStyleDescription[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}Configura las reglas que se aplican en\ncombate.");
const u8 localText_SoundDescription[] = _("{COLOR 1}{HIGHLIGHT TRANSPARENT}Configura el sonido como mono o\nestéreo.");
